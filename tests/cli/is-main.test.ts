 ...
 * entry path is the shebanged bin/<name>.ts launcher. Executed
 * directly, a library module must fail loudly — refusal message
 * naming the launcher, exit 1 — and never invoke main() (issue
 * #123's hazard class, eliminated by construction).
 */
