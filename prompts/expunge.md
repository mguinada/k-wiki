...
their influence: no claim, concept, entity, comparison, second-brain
page, or filed query may rest on material whose only support was a removed
...
`## [YYYY-MM-DD] expunge | <title>` — insert it as the new topmost
