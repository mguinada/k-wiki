...
7. Read the referenced docs and the related code, using Codegraph (`explore`, `node`, `impact`) rather than blind search; follow the repo's `AGENTS.md` router for the two agent contexts.
...
- `wiki/AGENTS.md` is never edited during wiki operations.
